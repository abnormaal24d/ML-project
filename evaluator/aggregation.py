...
def summarize_task_metrics(
    ...
    """Aggregate release-facing metrics from per-task evaluation metrics."""
    ...
    if recall_at_1_values:
        mean_recall_at_1 = sum(recall_at_1_values) / len(recall_at_1_values)

        metrics["retrieval_accuracy"] = mean_recall_at_1
        metrics["mean_recall_at_1"] = mean_recall_at_1

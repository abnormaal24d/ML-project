...
class VQAAccuracyStrategy:
    """Stateless scoring strategy for VQA accuracy evaluation."""
        ...
        *,
        ...
        for task_type, values in state.sequence_statistics.items():
            ...
            if definition is None:
                continue
            if definition.evaluation_method != "vqa_accuracy":
                continue

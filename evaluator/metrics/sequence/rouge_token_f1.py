"""ROUGE/Token F1 metric strategy."""
...
class RougeTokenF1Strategy:
    """Stateless scoring strategy for ROUGE/Token F1 evaluation."""
        ...
        *,
        ...
        for task_type, values in state.sequence_statistics.items():
            ...
            if definition is None:
                continue
            if definition.evaluation_method != "rouge_or_token_f1":
                continue
            ...
            metrics["rouge_l"] = values.rouge_l_sum / sample_count
...
def _accumulate_sequence_row_metrics(
    *,
    ...
    target_ids = _clean_token_ids(
        ...
        bos_id=special_tokens[1],
        eos_id=special_tokens[2],
        ignore_label=-100,
    )
    ...
    values.rouge_l_sum += _rouge_l_f1(
